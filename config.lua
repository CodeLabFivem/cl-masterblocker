...
Config.steam = {
    ...
    yessteam = true,  -- Allow players with Steam running (true/false)
    logo = "https://i.imgur.com/TiUV5Jw.png",
...
Config.notlauch = {
    master = false,  -- Enable or disable launch verification system
    serverName = "test",
    serverLogo = "https://i.imgur.com/TiUV5Jw.png",
...
Config.que = {
    ...
    maxPlayers = 1,  -- Maximum allowed players
